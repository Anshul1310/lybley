                            ...
                            <div className="fields1">
                                ...
                                <div className="admin">
                                    ...
                                    <div className="checkBoxes">
                                        ...
                                        <div className="check3">
                                            <h3>Earnings Page</h3>
                                            <input onChange={(e)=>handleAccessChange(e)} type="checkbox" name="earnings" id="" />
                                        </div>
                                        <div className="check3">
                                            <h3>Push Notification</h3>
                                            <input onChange={(e)=>handleAccessChange(e)} type="checkbox" name="notifications" id="" />
                                        </div>
                                        <div className="check3">
                                            <h3>Add News</h3>
                                         ...
                                         <div className="check3">
                                            ...
                                            <input onChange={(e)=>handleAccessChange(e)} type="checkbox" name="categories" id="" />
                                        </div>
                                          <div className="check3">
                                            <h3>Orders</h3>
                                          ...
                                          <div className="check3">
                                            ...
                                            <input onChange={(e)=>handleAccessChange(e)} type="checkbox" name="staticProducts" id="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
