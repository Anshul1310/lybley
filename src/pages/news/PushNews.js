...
const PushNews = () => {
 ...
 const handleChange=(e)=>{
    ...
    const handleClick=(e)=>{
            api.post("/api/news/add",{title, image, description,category
                }).then((data)=>{
                   navigate("/news")
                }).catch((err)=>{
                        ...
                        <div className="information">
                            <div className="fields">
                                <div className="newsInput">
                                    <label>Title</label>
                                    <input required type="text" onChange={(e)=>setTitle(e.target.value)} placeholder="Ex-Most purchased item" />
                                </div>
                                ...
                                <div className="newsInput">
                                    ...
                                    <textarea required rows='7' onChange={(e)=>setDescription(e.target.value)} placeholder="Ex-John doe products are the most purchased items"></textarea>
                                </div>
                                <div className="newsInput">
